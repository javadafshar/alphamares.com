...
export default function AuctionConfig() {
  ...
  return (
    ...
    >
      ...
      <div
        className="col"
        style={{ marginLeft: "15%", marginTop: "3%", display: "flex" }}
      >
        {!isEmpty(auction) && (
          <div
            style={{
          ...
          >
            ...
            <br />
            <h2 style={{ fontSize: "2.5rem", display: "flex", gap: "20px" }}>
              {" "}
              Sous-titre :{" "}
            ...
            <br />
            {auction.start && (
              <h2 style={{ fontSize: "1.8rem", display: "flex", gap: "20px" }}>
                {" "}
                Début :{" "}
                <p style={{ fontSize: "1.6rem", color: "white" }}>
                  {moment(auction.start).format("LLL")}
                </p>
              </h2>
            )}
            <br />
      ...
      <h1>Lots :</h1>
      <br />
      <Button variant="contained" onClick={() => setOpenLot(true)}>
        Créer un lot
      </Button>
      <br />
      <div
