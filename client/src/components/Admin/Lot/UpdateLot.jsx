...
export default function UpdateLot(props) {
  ...
  // Format current date to match input type date format (yyyy-MM-dd)
  const formattedCurrentDate = format(currentDate, "yyyy-MM-dd");

  // Determine the value to display in the TextField
  const displayDate = lot.productionDate || formattedCurrentDate;
      ...
      <form>
            ...
            <div style={{ display: "flex", gap: "2%" }}>
              ...
              <div style={{ flex: "1" }}>
                ...
                <Autocomplete
                  ...
                  size="small"
                  defaultValue={{
                    label: lot.sellerNationality,
                    code: lot.sellerNationality,
                  }}
        ...
        {lot.type === "ImplantedEmbryo" && (
          <div style={{ width: "100%" }}>
            ...
            <label htmlFor="Embryo" style={{ fontWeight: "bold" }}>
              Informations pour les embryons implanté :
            </label>
            <div
              id="Embryo"
              style={{
        ...
        {lot.type === "FrozenEmbryo" && (
          <div style={{ width: "100%" }}>
            ...
            {/* FrozenEMBRYO */}
            <label htmlFor="Embryo" style={{ fontWeight: "bold" }}>
              Informations pour les embryons congelé :
            </label>
            <div
              id="Embryo"
              style={{
